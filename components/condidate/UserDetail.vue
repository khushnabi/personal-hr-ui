<template>
  <div size="small" v-loading.fullscreen.lock="fullscreenLoading">
    ...
    <el-card class="box-card">
      ...
      <div class="text item">
        <router-link :to="'/create/'+user.id">
          <el-button type="difault" icon="el-icon-edit" size="small" circle></el-button>
        </router-link>
        <p>Name : {{user.name}}</p>
    ...
    <el-card class="box-card">
      <div class="tag-wrape">
        <div class="spec-tag">Skills</div>
      </div>
      <el-button @click="Addkills" class="addSkills" type="primary" size="small">
        <span style="font-weight:bold;" class="el-icon-plus"></span>
      </el-button>
      <br />
      <br />
    ...
    <el-card class="box-card">
      <div class="tag-wrape">
        <div class="spec-tag">Education</div>
      </div>
      <el-button @click="Addeducation" class="addSkills" type="primary" size="small">
      ...
      <div>
        <div v-for="eduUser in user.educations" :key="eduUser.id">
          <el-button
            type="danger"
            icon="el-icon-delete"
            @click="deleteEducation(eduUser.id)"
            size="small"
            circle
          ></el-button>
          <br />
    ...
    <el-card class="box-card">
      <div class="tag-wrape">
        <div class="spec-tag">Experiance</div>
      </div>
      <el-button @click="AddExperiance" class="addSkills" type="primary" size="small">
        <span class="el-icon-plus"></span>
      </el-button>
      <br />
      <br />
