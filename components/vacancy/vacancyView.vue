<template>
    <div class="container"  v-loading.fullscreen.lock="fullscreenLoading">
        ...
        <div v-for="vacancy in vacancies" :key="vacancy.id">
             <el-button type="danger" icon="el-icon-delete" circle size="small" @click="deleteVacancy(vacancy.id)"></el-button>
            <router-link :to="'/vacancy/'+vacancy.id+'/edit'"> <el-button type="default" icon="el-icon-edit" circle size="small" ></el-button></router-link>
